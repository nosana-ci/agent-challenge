...
export default function RiskScoreCard({ riskScore }: RiskScoreCardProps) {
  ...
  return (
    <div className="glass-dark card-glow hover-lift rounded-2xl p-6 shadow-xl relative overflow-hidden">
      ...
      <h3 className="text-xl font-bold text-white my-3 relative z-10 gradient-text">
        Risk Assessment
      </h3>

      {/* Recommendation Badge */}
      <div
        className={`mb-6 p-4 rounded-xl bg-gradient-to-r ${getRecommendationColor()} text-white neon-border relative z-10`}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-3xl float">{getRecommendationIcon()}</span>
            <div>
      ...
      <div className="space-y-4 mb-6 relative z-10">
        <div>
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="text-[#10E80C] font-semibold neon-glow-sm count-up">
              {riskScore.buy}%
            </span>
          </div>
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="text-yellow-400 font-semibold count-up">
              {riskScore.hold}%
            </span>
          </div>
          <div className="w-full glass rounded-full h-3">
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="text-red-400 font-semibold count-up">
              {riskScore.sell}%
            </span>
          </div>
          <div className="w-full glass rounded-full h-3">
      ...
      <div className="bg-slate-700/30 rounded-xl p-4">
        <div className="text-[#10E80C] font-semibold mb-3 text-sm">
          Key Factors:
        </div>
